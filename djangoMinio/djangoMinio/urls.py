...
# if this is enable instead of seeing the project you will see a page which
# shows a simple text as you will be launching soon
...
handler400 = "djangoMinio.error_views.error_400"  # bad_request
handler403 = "djangoMinio.error_views.error_403"  # permission_denied
handler404 = "djangoMinio.error_views.error_404"  # page_not_found
handler500 = "djangoMinio.error_views.error_500"  # server_error
