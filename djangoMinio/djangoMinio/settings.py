"""
Django settings for djangoMinio project.
...
WSGI_APPLICATION = "djangoMinio.wsgi.application"
...
MINIO_STORAGE_MEDIA_URL = config('MINIO_STORAGE_MEDIA_URL',
